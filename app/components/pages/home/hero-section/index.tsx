    ...
    return (
        <section className="py-[250px] bg-hero-image bg-cover bg-no-repeat  ">
            <div className="w-full relative flex justify-center items-center">
                <div className="w-[1024px] max-[1550px]:flex max-[1550px]:items-center max-[1550px]:flex-col max-[1550px]:text-center max-[1550px]:m-4">
                    ...
                    <div className="mt-9 lg:flex lg:items-center lg:gap-5 lg:flex-row sm:flex-col">
                        ...
                        <div className="flex items-center justify-center gap-2 text-gray-700 text-2xl m-2">
